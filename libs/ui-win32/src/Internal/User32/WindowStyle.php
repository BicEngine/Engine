...
/**
 * @internal WindowStyle is an internal library class, please do not use it in your code.
...
final class WindowStyle
{
    ...
    public const WS_POPUPWINDOW      = self::WS_POPUP | self::WS_BORDER | self::WS_SYSMENU;
